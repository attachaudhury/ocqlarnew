  ...
  if (!window.methodDraw) window.methodDraw = function ($) {
    ...
    Editor.init = function () {
      ...
      var elementChanged = function (window, elems) {
        var event = new CustomEvent('attaSvgCanvasChanged');
      ...
      attaCustomApiObject.changeZoom = changeZoom;
      ...
      */
      ...
      attaCustomApiObject.clickSelect = clickSelect
      ...
      attaCustomApiObject.clickRect = clickRect;
      ...
      attaCustomApiObject.clickZoom = clickZoom;
      ...
      attaCustomApiObject.clickText = clickText;
      ...
      attaCustomApiObject.clickUndo = clickUndo;
      ...
      attaCustomApiObject.clickRedo = clickRedo;
      ...
      var zoomSelectChange = function (zoom) {
        //var val = this.options[this.selectedIndex].text
        //val = val.split("%")[0]
        $("#zoom").val(zoom).trigger("change")
      }

      $('#zoom_select').on("change", zoomSelectChange);
      attaCustomApiObject.zoomSelectChange = zoomSelectChange;
